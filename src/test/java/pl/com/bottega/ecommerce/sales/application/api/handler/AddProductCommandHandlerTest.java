...
public class AddProductCommandHandlerTest {
    ...
    @Test
    public void shouldNotCallSuggestionServiceWhenProductIsAvailable() {
        ReservationRepository reservationRepository = Mockito.mock(ReservationRepository.class);
        Reservation reservation = Mockito.mock(Reservation.class);
        ProductRepository productRepository = Mockito.mock(ProductRepository.class);
        SuggestionService suggestionService = Mockito.mock(SuggestionService.class);
        ...
        Mockito.verify(suggestionService, Mockito.never()).suggestEquivalent(any(Product.class), any(Client.class));
    }
}